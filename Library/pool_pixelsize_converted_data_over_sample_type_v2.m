function [sample_type_data] = ...
    pool_pixelsize_converted_data_over_sample_type_v2(ROI_data, sample_type, sigma_lists, if_check_sample_type_profiles)

global pixelSize

pooled_image_size = 500;
pooled_image_pixelSize = 0.001; %in pre-ExM um

st_indices = find(ismember({ROI_data.SampleType},sample_type));
