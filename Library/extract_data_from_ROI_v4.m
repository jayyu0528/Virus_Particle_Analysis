function ROI_data = extract_data_from_ROI_v4(if_check_ROI_profiles, completed_workspace2_names, default_vals)
...
answer = inputdlg(...
    ...
    {default_vals{1},default_vals{2},default_vals{3}});

if ~strcmp(answer{1},'TG_1') && ~strcmp(answer{1},'TG_7') && ~strcmp(answer{1},'PAA_2') && ~strcmp(answer{1},'PAA_4') 
    error('Sample Type can only be TG_1,7 or PAA_2,4');
end
