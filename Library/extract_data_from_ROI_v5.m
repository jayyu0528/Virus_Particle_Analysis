function ROI_data = extract_data_from_ROI_v5(if_check_ROI_profiles, completed_workspace2_names, default_vals)
...
load([folder_path workspace2_name],'particle_data_2','lineLength2','p','sample_type')
...
answer = inputdlg(...
    {'Sample Type','Expansion Factor','Annotator'},'ROI Parameters',1,...
    {sample_type,default_vals{2},default_vals{3}});
...
%% Run Radii analysis
[Rdata , ~] = perform_radii_analysis_on_ROI([folder_path , workspace2_name]);
